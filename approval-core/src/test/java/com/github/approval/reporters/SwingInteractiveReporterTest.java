...
/**
 * User: github (Nikola Petrov) Date: 14-7-28 Time: 10:46
 */
...
public class SwingInteractiveReporterTest {
    ...
    public void shouldThrowAssertionError_IfCannotMoveApprovalFile() throws Exception {
        ...
        interactiveReporter.approveNew(com.github.approval.TestUtils.RAW_VALUE,
    ...
    public void shouldMoveCreatedFileIfReporterAcceptsIt() throws Exception {
        ...
        verify(reporter).approveNew(com.github.approval.TestUtils.RAW_VALUE, fileForApproval, testFile.file());
